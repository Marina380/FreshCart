...
import logo from "./../../assets/finalProject assets/images/registerlogo.jpg";
...
export default function Register() {
  ...
  return (
    <>
      ...
      <div className="lg:flex items-center  lsm:w-[95%]  lsm:mx-auto lsm:ms-6 sm:ms-3 md:ms-10 md:my-28 ">
        <div className=" lsm:mb-5 sm:ms-32 md:ms-0 lg:ms-7">
          <img
            src={logo}
            alt="#"
            className="max-w-none lsm:w-[120%] sm:w-[90%] sm:h-[300px] lg:w-[120%] md:w-[90%] l md:mx-auto md:h-auto object-cover sm:object-left-bottom"
          />
        </div>
        <form
